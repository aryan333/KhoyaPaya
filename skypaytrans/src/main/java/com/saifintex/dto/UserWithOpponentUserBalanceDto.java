...
public class UserWithOpponentUserBalanceDto extends BaseDto {
	...
	public SaiCardDTO getSaiCards() {
		return saiCards;
	}

	public void setSaiCards(SaiCardDTO saiCards) {
