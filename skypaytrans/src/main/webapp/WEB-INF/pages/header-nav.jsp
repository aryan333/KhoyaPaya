				...
				<ul class="nav" id="side-menu">
					...
					<li><a href="#"><i class="fa fa-users"
						...
						<ul class="nav nav-second-level">
							...
							<li><a href="userOtp">User OTP</a></li>	
					...
					<li><a href="#"><i class="fa fa-users"
							aria-hidden="true"></i> Sales Person<span class="fa arrow"></span></a>
							 ...
							 <ul class="nav nav-second-level">
							<li><a href="salesInfo"> SalesPerson Information</a></li>							
							<li><a href="filterSlaesPersonData"> Filter SalesPerson Data </a></li>
							</ul>
					</li>
					
					
					<li><a href="MerchantInfo"><i class="fa fa-envelope"
