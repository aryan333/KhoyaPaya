...
<body onload="loadRemainingOtp()">
	<nav class="navbar navbar-default navbar-static-top fixed-navbar"
		...
		<li style="padding: 0px 34px 0px 0px;"><a href="http://x1.saifintex.com/eko" target="_blank">Money Transfer</i></a>
		<li style="padding: 0px 34px 0px 0px;"><a onclick="refresh()"><i class="fa fa-refresh"></i></a>
		 ...
		 <div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse collapse in">
				<ul class="nav" id="side-menu">
					<li><a href="sdashboard"><i class="fa fa-dashboard fa-fw"></i>
							Dashboard</a></li>
					<li><a href="#"><i class="fa fa-users"
							aria-hidden="true"></i> Sales Person<span class="fa arrow"></span></a>
							 <!-- /.nav-second-level -->
							 
							 <ul class="nav nav-second-level">
							<li><a href="salesInfoSA"> SalesPerson Information</a></li>							
							<li><a href="filterSlaesPersonDataSA"> Filter SalesPerson Data </a></li>
							</ul>
					</li>
					
					
					<li><a href="MerchantInfoSA"><i class="fa fa-envelope"
							aria-hidden="true"></i> Merchant Info</a></li>
