							...
							<div class="row">
								...
								<div class="col-md-8">
									...
									<button type="button" style="float: right; margin-left: 10px;"
										class="btn btn-info multipleMarkersMapBtnDash" dateRange="all" >View All Users on Map</button>									
									<button type="button"  class="btn btn-info" style="float: right; margin-left: 10px;"
										id="exportBtn">Export As Excel</button>
									<button type="button" class="btn btn-info" style="float: right;" id="sendMail">
										Send Mail</button>
								</div>
							</div>
								...
								<table class="table table-striped table-bordered table-hover"
									...
									<tbody>
										<tr>
											...
											<td class="text-center">
												<button id="totalUsersBtn" type="button"
													...
													data-target="#onBoardedUsersListModalDiv" dateRange="all">
											...
											<td class="text-center"><button id="todayUsersBtn"
													...
													data-target="#onBoardedUsersListModalDiv" dateRange="today">
													<strong> ${userStats.todayUsers} </strong>
												</button></td>
											<td class="text-center">
												<button id="yesterdayUsersBtn" type="button"
													class="btn btn-link" data-toggle="modal"
													data-target="#onBoardedUsersListModalDiv" dateRange="yest">
											...
											<td class="text-center">
												<button id="usersInWeekDateRangeBtn" type="button"
													class="btn btn-link" data-toggle="modal"
													data-target="#onBoardedUsersListModalDiv" dateRange="week">
											...
											<td class="text-center">
												<button id="usersInDateRangeBtn" type="button"
													class="btn btn-link" data-toggle="modal"
													data-target="#onBoardedUsersListModalDiv" dateRange="start">
										...
										<tr>
											...
											<td  class="text-center"> <button type="button" class="btn btn-link bySalesPersonTotalUsersBtn" dateRange="all" data-toggle="modal" data-target="#onTotalReferalUsers" >
												 ${spreferalStats.overAllTotalCount} </button>
											</td>
											
											<td class="text-center"><button type="button" class="btn btn-link bySalesPersonTodayUsersBtn" dateRange="today" data-toggle="modal" data-target="#onTotalReferalUsers" >
												 ${spreferalStats.totalCurrentDateCount} </button>
											</td>
												
											<td class="text-center"><button type="button" class="btn btn-link bySalesPersonYesterdayUsersBtn" dateRange="yest" data-toggle="modal" data-target="#onTotalReferalUsers" >
												${spreferalStats.totalYesterdayDateCount} </button>
											</td>
											
											<td class="text-center" ><button type="button" class="btn btn-link bySalesPersonInWeekRangeUsersBtn" dateRange="week" data-toggle="modal" data-target="#onTotalReferalUsers" >
												 ${spreferalStats.totalWeekCount} </button>
											</td>
											
											<td  class="text-center"><button type="button" class="btn btn-link bySalesPersonInDateRangeUsersBtn" dateRange="start" data-toggle="modal" data-target="#onTotalReferalUsers" >
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<button type="button" class="close" data-dismiss="modal"
								...
								<button type="button" class="btn btn-info multipleMarkersMapBtnModal" style="float: right; margin-right: 10px;"
										  >View All Users on Map</button>
