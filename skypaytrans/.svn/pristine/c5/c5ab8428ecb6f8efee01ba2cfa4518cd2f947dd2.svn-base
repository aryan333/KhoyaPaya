		...
		<div id="page-wrapper">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<button id="button" type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo"  style="float: right; margin-right: 10px;"><span class="glyphicon glyphicon-collapse-up"></span>Hide</button>
						<div class="panel-heading" >Ezkhata Users Statistics
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
					<button id="button1" type="button" class="btn btn-info" data-toggle="collapse" data-target="#demo1"  style="float: right; margin-right: 10px;" ><span class="glyphicon glyphicon-collapse-down" style="size:5px;"></span>show</button>
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<button type="button"  class="btn btn-info"  style="float: right; margin-right: 10px; background-color: green;"
										id="viewBlupayUsersOnMap">View Users on Map</button>
