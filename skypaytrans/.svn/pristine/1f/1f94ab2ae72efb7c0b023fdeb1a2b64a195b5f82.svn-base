...
public class BluPayUsersController extends AbstractBase {
	...
	@RequestMapping(value = "/blupayUsersOnmap/{period}", method = RequestMethod.GET)
	public ModelAndView blupayUsersOnmapHandler(@PathVariable("period") String period,
			@RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate) {
		getLogger().info("=====/blupayUsersOnmap/" + period + " == " + startDate + "  ==" + endDate);
		return new ModelAndView("blupayUsersOnMap").addObject("startDate", startDate)
				.addObject("endDate", endDate).addObject("period", period);

	}
	
	
	
	@RequestMapping(value = "/getBlupayUsersOnMap/{period}", method = RequestMethod.GET)
	public @ResponseBody ResponseEntity<?> getBlupayUsersOnMap(@PathVariable("period") String period,
			@RequestParam("startDate") String startDate, @RequestParam("endDate") String endDate) {
		getLogger().info("=====/getBlupayUsersOnMap/" + period + " == " + startDate + "  ==" + endDate);
		List<LatLngDTO> list = userService.getBlupayUsersLatLngService(period, startDate, endDate);
	...
	@RequestMapping(value = "/getOnBoardedUsersLatLng/{dateRange}", method = RequestMethod.GET)
	public @ResponseBody ResponseEntity<List<LatLng>> latLngHandler(@PathVariable("dateRange") String dateRange) {
		...
		List<LatLngDTO> list = userService.getOnBoardedUsersLatLng(dateRange);
	...
	@RequestMapping(value = "/map/{dateRange}", method = RequestMethod.GET)
	public ModelAndView blupayUsersmapHandler(@PathVariable("dateRange") String dateRange
			) {
		getLogger().info("=====/blupayUsersOnmap/" + dateRange + " == ");
		return new ModelAndView("map").addObject("dateRange", dateRange);
