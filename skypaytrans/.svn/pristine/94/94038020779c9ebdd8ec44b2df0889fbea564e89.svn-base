...
<body>
	...
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h1 class="page-header">Sales Person Information</h1>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			...
			<div class="row" >
				<div class="col-lg-12">
					...
					<button type="button"  class="btn btn-info"  style="float: right; margin-right: 10px;"
										id="allUserBySPInDateRangeMapBtnDashboard">View All Registered Users on Map</button>
							...
							<div class="table-responsive">
								<table  class="table table-striped table-bordered table-hover">
									...
									<tbody>
										...
										<td > <button type="button" class="btn btn-link bySalesPersonTotalUsersBtn" dateRange="all" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.overAllTotalCount} </button> </strong>
											</td>
											
											<td ><button type="button" class="btn btn-link bySalesPersonTodayUsersBtn" dateRange="today" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.totalCurrentDateCount} </button> </strong>
											</td>
												
											<td ><button type="button" class="btn btn-link bySalesPersonYesterdayUsersBtn" dateRange="yest" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.totalYesterdayDateCount} </button> </strong>
											</td>
											
											<td ><button type="button" class="btn btn-link bySalesPersonInWeekRangeUsersBtn" dateRange="week" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.totalWeekCount} </button> </strong>
											</td>
											
											<td ><button type="button" class="btn btn-link bySalesPersonInDateRangeUsersBtn" dateRange="start" data-toggle="modal" data-target="#onTotalReferalUsers" >
										...
										<td > <button type="button" class="btn btn-link bySalesPersonTotalUsersBtnNAP" dateRange="all" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.overAllTotalCountNAP} </button> </strong>
											</td>
											
											<td ><button type="button" class="btn btn-link bySalesPersonTodayUsersBtnNAP" dateRange="today" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.totalCurrentDateCountNAP} </button> </strong>
											</td>
												
											<td><button type="button" class="btn btn-link bySalesPersonYesterdayUsersBtnNAP" dateRange="yest" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.totalYesterdayDateCountNAP} </button> </strong>
											</td>
											
											<td ><button type="button" class="btn btn-link bySalesPersonInWeekRangeUsersBtnNAP" dateRange="week" data-toggle="modal" data-target="#onTotalReferalUsers" >
												<strong> ${totaluser.totalWeekCountNAP} </button> </strong>
											</td>
											
											<td><button type="button" class="btn btn-link bySalesPersonInDateRangeUsersBtnNAP" dateRange="start" data-toggle="modal" data-target="#onTotalReferalUsers" >
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading" id="tablePanelHeading" > <strong class="text-success">Sales Person Details With Registered User</strong> </div>
						<!-- /.panel-heading -->
						<div class="panel-body">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading" id="tablePanelHeading"><strong class="text-danger">Sales Person Details with NAP USER</strong> </div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="table-responsive" id="tableArea">
					...
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal"
								aria-hidden="true">×</button>
							<button type="button" class="btn btn-info" style="float: right; margin-right: 10px;"
										id="allUserBySPInDateRangeMapBtnModal">View All Users on Map</button>	
