...
<body class="body-bg">
    ...
    <div class="horizontal-main-wrapper">
        ...
        <!-- page title area end -->
         ...
         <div class="main-content-inner">
                     ...
                     <!-- page title area end -->
            <div class="main-content-inner" id="foundtable">
                <div class="row">
                    <!-- table primary start -->
                    <div class="col-md-1">
                    ...
                    <!-- for dropdown and search bar div start -->
                    
                    <div class="card">
                            <div class="card-body">
                                <p> Filter Location List</p>
                                <div class="drop-buttons row">
                                    <div class="dropdown col-lg-6 col-md-4 col-sm-6">
                                      
                                            <select id="masterstate1">
                                    ...
                                    <p></p>
                                    <button type="button" data-toggle="modal" data-target="#exampleModalLong" class="btn btn-outline-primary mb-3">Add Location</button>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                               ...
                                               <select id="modalstatedata"> </select>
                    ...
                    <!-- for data table div start -->
                    
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Location Master List</h4>
   ...
   <script src="../resources/assets/js/request.js"></script>
    <script src="../resources/assets/js/userform.js"></script>
     ...
     <script>
   // window.onload = createFoundTable();
    </script>
     <script>
